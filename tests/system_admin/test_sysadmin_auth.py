"""
Test script for System Administrator - Authentication
Tests: System admin login and logout
"""
...
def test_admin_login():
    ...
    print_test_header("System Admin Login")
    ...
    try:
        ...
        print(f"✗ FAIL | Controller not running on port 5009")
        return False, None
...
def test_logout():
    """Test System Admin Logout"""
    print_test_header("System Admin Logout")
...
def main():
    ...
    print("\n" + "="*60)
    print("SYSTEM ADMINISTRATOR - AUTHENTICATION TESTS")
    print("="*60)
    ...
    # Run tests
    login_result, username = test_admin_login()
    results.append(('System Admin Login', login_result))
    
    invalid_result = test_invalid_login()
    results.append(('Invalid Login Attempts', invalid_result))
    
    logout_result = test_logout()
    results.append(('System Admin Logout', logout_result))
